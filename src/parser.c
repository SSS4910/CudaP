...
int parse_line(char * line, Request *outRequest)
{
    ...
    for(i =0; i < strlen(line); i++)
    {
            ...
            //this parses and breaks down the line into fields, each case is a different field 
        switch(currentField)
        {
